...
try {
    $resourcesToFetch = [
        ["name" => "musicContent", "result" => (isset($_GET["owner"])) ? 
         (new MusicModel())->getMusicByOwner($_GET["owner"]) :
         (new MusicModel())->getAllMusic()],
        ["name" => "services", "result" => (new ServiceModel())->getAllServices()],
        ["name" => "books", "result" => (isset($_GET["owner"])) ?
         (new BooksModel())->getBooksByOwner($_GET["owner"]) :
         (new BooksModel())->getAllBooks()],
        ["name" => "news", "result" => (new NewsModel())->getAllNews()],
        ["name" => "events", "result" => (isset($_GET["owner"])) ?
         (new EventModel())->getEventsByOwner($_GET["owner"]) :
         (new EventModel())->getAllEvents()],
...
if($query){
    ...
    switch($query){
        ...
        case 'getUserProfile':
            ...
            //session_id($_GET['sid']);
            //session_start();
            $finalReponse = $controller->getUserProfile($_GET['username']);
            break;
