...
import {initFormSubmitHandler, uploadCompleteHandler, uploadProgressHandler, showProgress} from './admin_profile_control.js';
...
document.getElementById('albumForm').addEventListener('submit', function(e) {
    ...
    const method = 'POST';
    const url = '/konektem/api/albums/create';
