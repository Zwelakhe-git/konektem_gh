...
let musicList = [];
const styles = [
    '/experimental/CSS/musicplayer.css'
];
let isPlaying = false;

function playerHtml(){
    let modal = document.createElement('div');
    modal.classList.add('modal', 'slide-in', 'from-right');
    ...
    modal.innerHTML = `
        ...
        <div id="player-win">
            <div id="win-header">
                ...
                <div class="track-title">
                    <span class="title-text">${musicData.title}</span><br/>
            ...
            <div id="win-body">
                <div class="track-img">
                    <div class="image"
                    ${musicData.image_url ?
                        `style="background-image: url(${musicData.image_url});
                        background-size: contain; background-position: center;"` :
                        ""}>
                        <!-- default - music icon -->
                        ${musicData.image_url ? '' : `<i class="fas fa-music icon"></i>`}
                    </div>
                </div>
                <div class="controls">
                    <div id="play-stat">
        ...
        <audio id="player" src="${musicData.url}"></audio>
    `;
    return modal;
}
