...
document.getElementById('addTrackBtn').addEventListener('click', function() {
    ...
    const audioFiles = document.getElementById('audio_file').files;
...
function showQRCode(base64Data, albumId){
    let qrCodeModal = new bootstrap.Modal(document.getElementById("qrcode-modal"));
    let closeModalBtn = document.querySelector(".close-qrcode-modal-btn");
