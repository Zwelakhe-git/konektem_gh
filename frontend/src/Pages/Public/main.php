...
<div id="main" class="d-md-grid m-md-auto py-md-3 px-md-3 white-bg">
    ...
    <div id="newsFadeSection" class="section shelf-anim container-outer mt-md-0 mb-sm-max-3 pad-20 white-bg bdr-box">
        <div class="container-bg position-absolute" id="events-list-bg"></div>
     ...
     */
    $maxMusicContent = 5;
    $tracks = array_values(array_filter($music, fn($item) => $item['position'] === 'mainpage'));
//\Konektem\Utils\Log::info("main page tracks: " . print_r($tracks, true));
    ...
    <div id="books-panel" class="section shelf-anim container-outer mt-md-0 mb-sm-max-3 pad-20 white-bg bdr-box">
        <div class="container-bg position-absolute" id="books-list-bg"></div>
        <div class="section-info">
...
?>
        <div class="slide-container">
            <img type="<?= $slide['mime_type'] ?>" src="<?= $slide['src'] ?>" loading="lazy"/>
        </div>
<?php }?>
    </div>
</div>
