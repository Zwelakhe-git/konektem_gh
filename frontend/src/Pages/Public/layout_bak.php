...
<html>
    ...
    <body data-theme="light">
        ...
        <div id="nav-panel" class="grey-clr overflow-hidden no-margin">
        ...
        <div id="nav-panel-bottom" class="grey-clr overflow-hidden no-margin">
            <div class="nav" class="overflow-hidden">
