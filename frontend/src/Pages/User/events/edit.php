...
<form method="POST" enctype="multipart/form-data" class="edit-form">
        ...
        <div class="col-md-4">
            <div class="mb-3">
                ...
                <input type="file" class="form-control" id="event_image" name="event_image" 
                       accept="image/*" data-preview="eventImagePreview">
                
                <?php if ($event['image_url']): ?>
                <div class="mt-2">
                    <p>Imaj aktyel:</p>
                    <img src="<?= $event['image_url'] ?>" width="200" class="img-thumbnail" id="eventImagePreview">
    ...
    <div class="mt-4">
        ...
        <a href="<?= BASE_URL?>/user/me/events" class="btn btn-secondary">
            Anile
        </a>
