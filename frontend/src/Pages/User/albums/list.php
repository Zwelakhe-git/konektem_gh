...
<div class="row">
    ...
    <div class="col-12 text-center py-5">
        <div class="empty-state">
            ...
            <a href="<?= BASE_URL ?>/user/me/albums/create" class="btn btn-primary mt-3">
                <i class="fas fa-plus"></i> Ajoute album
            </a>
        </div>
    </div>
    ...
    <div class="col-md-4 mb-4">
        <div class="card h-100 album-card" data-album-id="<?= $album['id'] ?>">
            ...
            <div class="card-footer bg-transparent">
                <a href="<?= BASE_URL ?>/user/me/albums/<?= $album['id'] ?>/preview" class="btn btn-sm btn-info" title="Voir details">
                    <i class="fas fa-eye"></i>
                </a>
                <a href="<?= BASE_URL ?>/user/me/albums/<?= $album['id'] ?>/edit" class="btn btn-sm btn-warning" title="Modifye album">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger" id="confirmDeleteBtn">Efase</button>
            </div>
        </div>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    confirmDeleteBtn.addEventListener('click', function() {
        if (albumToDelete) {
            ...
            fetch(`/konektem/user/me/albums/${albumToDelete}/delete`, {
                method: 'POST',
                headers: {
