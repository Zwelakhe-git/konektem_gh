...
<form method="POST" enctype="multipart/form-data" id="albumForm" class="edit-form">
                        ...
                        <div class="list-group-item" data-track-id="<?= $track['id'] ?>">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    <strong><?= htmlspecialchars($track['title']) ?></strong><br>
                                    <small class="text-muted"><?= htmlspecialchars($track['artist_name'] ?? '') ?></small>
                                </div>
                                <div class="btn-group">
                                    <a href="<?= BASE_URL?>/user/me/albums/<?= $track['id'] ?>/edit" class="btn btn-sm btn-warning" title="Modifye piste">
    ...
    <div class="mt-4">
        ...
        <a href="<?= BASE_URL?>/user/me/albums" class="btn btn-secondary">
