<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="<?= BASE_URL?>/admin/partners/create" class="btn btn-primary">
        <i class="fas fa-plus me-2 d-none d-md-inline"></i>Ajoute patne
    </a>
</div>
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="text-center py-5">
            ...
            <a href="<?= BASE_URL?>/admin/partners/create" class="btn btn-primary mt-2">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="bg-light rounded d-flex align-items-center justify-content-center" 
                                ...
                                <img src="<?= $partner['image_url']?>" style="object-fit: cover; width: 100%; height: 100%" class="rounded"/>
                            </div>
                            <?php else: ?>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm w-100">
                                <a href="<?= BASE_URL?>/admin/partners/<?= $partner['id'] ?>/edit" 
                                   class="btn btn-outline-primary" title="Редактировать">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a 
                                   class="btn btn-outline-danger del-btn" data-id="<?= $partner['id']?>"
                                   title="Удалить">
