...
<form method="POST" enctype="multipart/form-data" class="create-form">
    ...
    <div class="mb-3">
        ...
        <textarea class="form-control tinymce-editor" id="description" name="description" rows="5"></textarea>
    </div>
    ...
    <a href="<?= BASE_URL?>/admin/services" class="btn btn-secondary">Anile</a>
</form>
<script>
window.formSelector = 'form';
window.action = 'create';
window.item = 'services';
