<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="btn-group">
        <button type="button" class="btn btn-outline-secondary dropdown-toggle" data-bs-toggle="dropdown">
            <i class="fas fa-download me-2"></i>Eskpòte
        </button>
        ...
        <form class="row g-3">
            <div class="col-md-3">
                ...
                <select class="form-select" onchange="filterOrders()" id="statusFilter">
                    <option value="">Tout stati</option>
                    <option value="pending">Atant</option>
                    <option value="confirmed">Konfime</option>
                    <option value="cancelled">Anile</option>
                    <option value="completed">Konplete</option>
                </select>
            </div>
            <div class="col-md-3">
                <label class="form-label">Stati pèman</label>
                <select class="form-select" onchange="filterOrders()" id="paymentFilter">
                    <option value="">Tout stati</option>
                    <option value="pending">Atant peman</option>
                    <option value="paid">Peye</option>
                    <option value="failed">Erè pèman</option>
                    <option value="refunded">Retounen</option>
                </select>
            </div>
            <div class="col-md-3">
                <label class="form-label">Sòti</label>
                <input type="date" class="form-control" onchange="filterOrders()" id="dateFrom">
            </div>
            <div class="col-md-3">
                <label class="form-label">Jiska</label>
...
<div class="card" style="margin-bottom: 20px">
    ...
    <div class="card-body p-0">
        ...
        <div class="text-center py-5">
            ...
            <h4 class="text-muted">òdè entrouvab</h4>
            <p class="text-muted">Isit lan tout òdè tikè yo</p>
        </div>
        <?php else: ?>
            ...
            <table class="table table-hover mb-0" id="ordersTable">
                <thead class="table-light">
                    <tr>
                        ...
                        <th>Kliyan</th>
                        <th>Evènman</th>
                        <th width="100" class="text-center">Tikè</th>
                        <th width="120" class="text-center">Total</th>
                        <th width="140" class="text-center">Stati òdè</th>
                        <th width="140" class="text-center">Stati pèman</th>
                        <th width="120" class="text-center">Aksyon</th>
                    </tr>
                </thead>
                <tbody>
