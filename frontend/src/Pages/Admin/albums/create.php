...
<form method="POST" enctype="multipart/form-data" id="albumForm" class="">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="mb-3">
                ...
                <select class="form-control" id="artist_name" name="artist_name" required>
                    <option value="<?= $_SESSION['user']['name'] ?>" selected><?= $_SESSION['user']['name'] ?></option>
                    <option value="new">+ Ajouter nouvel artiste</option>
    ...
    <a href="<?= BASE_URL?>/admin/albums" class="btn btn-secondary cancel">Annuler</a>
</form>
