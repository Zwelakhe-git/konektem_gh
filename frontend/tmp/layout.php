...
<html>
    <head>
        ...
        <script src="/konektem/static/js/toast-notification.js" defer></script>
        <script src="/konektem/static/js/main-page-script.js" type="module"></script>
        <?php if(isset($styles)){
    ...
    <body>
        ...
        <div id="nav-panel" class="grey-clr no-ovrflw no-margin">
            <div id="nav" class="no-ovrflw">
                ...
                <a tabindex="0" class="bdr-10 nav-link <?= $page === 'interviews' ? 'active' : '' ?>" href="<?= BASE_URL?>/interviews">
                ...
                <a tabindex="0" class="bdr-10 nav-link <?= $page === 'services' ? 'active' : '' ?>" href="<?= BASE_URL?>/services">
                ...
                <a tabindex="0" class="bdr-10 nav-link <?= $page === 'contacts' ? 'active' : '' ?>" href="<?= BASE_URL?>/contacts">
        ...
        <?php if(!empty($_SESSION['user'])) require_once 'profile-settings-modal.php';?>
    </body>
</html>
