...
class EmailModel {
    ...
    public function __construct($from_email = SITE_EMAIL, $reply_to = SITE_EMAIL, array $config = []) {
        ...
        $this->config = array_merge([
            ...
            'from_name' => 'Konektem',
            'reply_to' => $reply_to,
            'reply_to_name' => 'Konektem Support'
        ], $config);
    ...
    private function addEmbeddedImages($html) {
        ...
        $logoPath = HTDOCS . '/media/images/favicon.png';
    ...
    private function findImageByCid($cid) {
        $possiblePaths = [
            HTDOCS . '/media/images/' . $cid . '.png',
            HTDOCS . '/media/images/' . $cid . '.jpg',
    ...
    private function log($level, $message, $context = []) {
        ...
        $logLine = "$message $contextStr\n";
        if((strtolower($level)) === 'success'){
            Log::info($logLine);
